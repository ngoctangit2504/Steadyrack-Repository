...
const Footer = () => {
  return (
    <footer className="bg-black text-white py-10">
      ...
      <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 text-sm">
        ...
        <div>
          ...
          <div className="flex items-center border border-white rounded-full px-4 py-2">
            <input type="email" placeholder="YOUR EMAIL" className="bg-transparent flex-grow outline-none text-white placeholder-gray-400" />
            <button className="bg-white text-black font-bold px-4 py-2 rounded-full">SUBSCRIBE</button>
          </div>
      ...
      <div className="flex justify-center space-x-4 mt-4">
        <button className="border border-gray-600 px-4 py-2 rounded-full text-xs">UNITED STATES</button>
        <button className="border border-gray-600 px-4 py-2 rounded-full text-xs">USD $</button>
        <button className="border border-gray-600 px-4 py-2 rounded-full text-xs">ENGLISH</button>
      </div>
    </footer>
  );
};
