              ...
              <div className="py-4 grid grid-cols-2 gap-x-4 gap-y-2">
                <label className="flex items-start space-x-2">
                  ...
                  <input
                    ...
                    className="appearance-none h-4 w-4 border border-black bg-white checked:bg-black checked:border-black checked:before:content-['✓'] checked:before:text-white checked:before:text-center checked:before:block checked:before:w-full checked:before:h-full checked:before:leading-4"
                  />
                  <span className="text-sm flex-1 break-words">Mountain</span>{" "}
                  {/* Thêm flex-1 break-words */}
                </label>
                ...
                <label className="flex items-start space-x-2">
                  ...
                  <span className="text-sm flex-1 break-words">
                    Designed to install seamlessly behind all Steadyrack bike
                    racks.
                  </span>
                </label>
                ...
                <label className="flex items-start space-x-2">
                  ...
                  />
                  <span className="text-sm flex-1 break-words">
                    Fat: Cruisers, Plus, and Fat Bikes
                  </span>
                </label>
                ...
                <label className="flex items-start space-x-2">
                  ...
                  />
                  <span className="text-sm flex-1 break-words">
                    Integrated behind all ProFlex racks and can be seamlessly
                    installed behind existing Classic Range bike racks.
                  </span>
                </label>
                ...
                <label className="flex items-start space-x-2">
                  ...
                  />
                  <span className="text-sm flex-1 break-words">
                    Narrow: Road, Gravel, BMX, Fender, and City Bikes
                  </span>
                </label>
                ...
                <label className="flex items-start space-x-2">
                  ...
                  />
                  <span className="text-sm flex-1 break-words">
                    Wide: MTB, eMTB, and Gravel Bikes
                  </span>
                </label>
                {/* Add more checkbox options as needed */}
              </div>
