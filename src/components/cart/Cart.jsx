...
const Cart = () => {
  ...
  const handleCheckout = () => {
    if (cartItems.length > 0) {
      const checkoutUrl =
        "https://www.steadyrack.com/checkouts/cn/Z2NwLWFzaWEtc291dGhlYXN0MTowMUpOWVRLWUozUEEwUDJRM0VUUDlLVjZCSw/information";
      ...
      <div className="fixed inset-y-0 right-0 pl-0 sm:pl-10 max-w-full flex ">
        ...
        >
          <div className="h-full flex flex-col bg-white rounded-2xl shadow-xl m-2">
                          ...
                          <div className="ml-0 sm:ml-4 flex-1 flex flex-col">
                            ...
                            <div className="flex-1 flex items-end justify-between text-sm">
                              <div className="flex items-center border">
                                ...
                                <span className="px-2 py-1 border text-gray-900">
                                  {item.quantity}
                                </span>
                                <button
                                  onClick={() =>
            ...
            <div className="my-2">
              <h1 className="text-center font-semibold tracking-tight text-black">
                You May Also Like
              </h1>
            </div>
            ...
            {cartItems.length > 0 && (
              <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                ...
                <div className="mt-6 flex justify-center text-sm text-center text-gray-500"></div>
              </div>
            )}
          </div>
        </div>
