  ...
  render() {
    return (
      <div data-aos="fade-up" className="container mx-auto px-4 pt-20">
        ...
        <div data-aos="fade-up" className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1">
          {this.styles.map((style, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-opacity-30 flex flex-col justify-end p-5">
                <h3 className="text-white text-3xl font-semibold mb-2">{style.name}</h3>
                <ButtonD/>
              </div>
            </div>
          ))}
