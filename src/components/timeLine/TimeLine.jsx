...
const timelineData = [
  {
    ...
    image:
      "//www.steadyrack.com/cdn/shop/files/2004_1.png?v=1737009144&width=3200",
  },
  {
    year: "2009",
    description:
    ...
    image:
      "//www.steadyrack.com/cdn/shop/files/2009.png?v=1737010082&width=3200",
  },
  {
    year: "2009 - 2016",
    description:
    ...
    image:
      "//www.steadyrack.com/cdn/shop/files/2009-2016.png?v=1737010698&width=3200",
  },
  {
    year: "2021",
    description:
    ...
    image:
      "//www.steadyrack.com/cdn/shop/files/2021.png?v=1737011609&width=3200",
  },
  {
    year: "2022",
    description:
    ...
    image:
      "//www.steadyrack.com/cdn/shop/files/2022.png?v=1737011698&width=3200",
  },
  {
    year: "2023",
    description:
      "The release of our eBike Rack (now discontinued), a valuable member of the collection. The launch of our eBike Rack was a game-changer, as it allowed for larger tire capacities and weights, compared to our original Fender Rack (discontinued).",
    image:
      "https://www.steadyrack.com/cdn/shop/files/2023_72bbf6d9-4357-4228-a811-147fdb5f165f.png?v=1737013162&width=2000",
  },
  {
    year: "2024",
    description:
      "The release of our eBike Rack (now discontinued), a valuable member of the collection. The launch of our eBike Rack was a game-changer, as it allowed for larger tire capacities and weights, compared to our original Fender Rack (discontinued).",
    image:
      "https://www.steadyrack.com/cdn/shop/files/2024.png?v=1737014860&width=2000",
  },
  {
    year: "2025",
    description:
      "The release of our eBike Rack (now discontinued), a valuable member of the collection. The launch of our eBike Rack was a game-changer, as it allowed for larger tire capacities and weights, compared to our original Fender Rack (discontinued).",
    image:
      "https://www.steadyrack.com/cdn/shop/files/2025.png?v=1739935878&width=2000",
  },
];
        ...
        {timelineData.map((item, index) => (
          ...
          >
            <div className="p-4 pb-3">
              <h2 className="text-xl font-bold mb-2 pb-1 border-black border-b-2">
                {item.year}
              </h2>
