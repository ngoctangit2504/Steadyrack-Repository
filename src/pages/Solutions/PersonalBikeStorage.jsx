...
function PersonalBikeStorage() {
  ...
  const faqs = [
    {
      question: "What are the ergonomic benefits of storing my bike in a Steadyrack?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes –  all five of our racks pivot to the left and right.",
    },
    {
    ...
    {
      question: "How far will my bike stick out from the wall when pivoted against the wall?",
      answer:
    ...
    <div>
     ...
     <div className='py-20'>
        <div data-aos="fade-up" className=' mx-96 px-5'>
           <h1 className='text-black text-4xl font-semibold text-center tracking-tight mb-7'>Find the perfect Steadyrack to keep your bikes organized and your home tidy.</h1>
           <p className='text-black text-base text-center tracking-tight mb-4'>Steadyrack’s wall-mounted bike racks are a unique, patented bike storage solution. Our compact bike storage racks are easy to use, easy to load and unload and save space in your home or garage while keeping your bikes safe & secure.</p>
           <p className='text-black text-base text-center tracking-tight mt-4'>It's your bike, and we think it deserves the best. That's why we designed the world's best bike rack. Don't just take our word for it though, take it from the millions of people all over the world who choose to keep their bikes safe and secure in a Steadyrack.</p>
        </div>
     </div>

     <div>
        <div data-aos="fade-up" className='py-0.5 px-5'>
            <h1 className=' font-impact italic text-10xl text-black tracking-tight uppercase text-center whitespace-nowrap'>Original Innovators</h1>
        </div>
     </div>
        ...
        <div className='px-5 grid grid-cols-2'>
           ...
           <div className=' flex px-1.5 items-center justify-center'>
             <div data-aos="fade-up" className='py-10 px-20'>
                <h1 className='text-black text-4xl font-semibold tracking-tight mb-5'>Space Saving Bike Storage – Upright Bike Storage Rack</h1>
                <p className='text-base test-black mb-5 leading-tight'>Steadyrack allows you to hang your bike vertically on the wall. This is a space saving bike storage solution for any room and also protects your bike. Getting your bike off the floor and onto the wall, stored away correctly. With a range of Steadyrack’s available to suit almost any type of bike you have. You’ll be impressed by how much space you’ll save with our vertical bicycle storage racks.</p>
     ...
     <div className='pt-9 pb-5 bg-black'>
        ...
        <div className=' flex px-1.5 items-center justify-center'>
             <div data-aos="fade-up" className='py-10 px-20'>
                <h1 className='text-white text-4xl font-semibold tracking-tight mb-5'>Bike Storage Made Easy with Steadyrack</h1>
                <p className='text-base text-white mb-5 leading-tight'>Steadyrack’s range of bike racks provide an answer to all your space saving and bike storage needs. In a world where space is limited in many houses, apartments, living rooms, garages, and sheds around the world, it’s increasingly hard to find or create space to store your bike. Bicycles are large items when they’re horizontal, making them clunky to store without a dedicated bike storage solution. There’s a lot more unutilized wall space on offer that can help solve this problem and our Steadyrack bike rack safely provides a compact, space saving bike storage solution.</p>
                <button className="py-3.5 px-5 bg-white text-black text-sm font-semibold rounded-full shadow-md border-2 border-black hover:bg-red-600 hover:text-white hover:border-white transition inline-flex items-center justify-center min-w-[40px]">
                  SHOP NOW
                </button>
             </div>
