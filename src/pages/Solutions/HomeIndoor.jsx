...
function HomeIndoor() {
  ...
  const faqs = [
    {
      question:
        "Is it possible to use the Steadyrack with the rear wheel in the rack and the front wheel down?",
      answer:
    ...
    {
      question:
        "How do you get your bike in the front wheel position without lifting?",
      answer:
    ...
    {
      question:
        "Can I install my Steadyrack to Drywall, Plasterboard or Gyprock?",
      answer:
        ...
        <div className="relative z-10 flex justify-center items-end h-full text-center">
          <div className="">
            <h1 className="text-9xl text-white font-bold font-impact uppercase italic tracking-tight mb-10">
              Personal Indoor Storage Solutions
            </h1>
          </div>
        </div>
      </div>
      ...
      <div className="py-20">
        <div data-aos="fade-up" className=" mx-96 px-5">
          <h1 className="text-black text-4xl font-semibold text-center mb-7">
            Store Your Bike Indoors With Steadyrack
          </h1>
          <p className="text-black text-base tracking-tight text-center mb-4">
            Whether you have one bike or multiple, an indoor bike rack storage
            solution is the easiest way to keep your bikes out of the way and
            protected when not in use. Steadyrack’s bike storage allows
            customers to store their bikes easily, no matter if they have a
            large living area or small apartment. It’s the perfect space saving
            solution and, because it’s so easy to use, it will help you get out
            on your bike faster. Who knows, you may even want to cycle more
            because of it!
          </p>
        </div>
      </div>
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              ...
              <p className="text-base test-black mb-5 leading-tight">
                Indoor bike wall mounts are the perfect storage solution for
                anyone wanting to store their bikes safely and securely. Take
                the stress out of leaving your bike in a common bike parking
                space, or outside, where it could be damaged or stolen. Bike
                hooks and other storage solutions can often damage rims, frames
                and even your walls. Steadyrack’s bike rack only ever touches
                your tire and is safe for any type of bike, even those with
                hydraulic brakes. Steadyrack’s bike racks for the house allows
                customers to store easy in the comfort of their own living room,
                garage, or apartment. By using a vertical rack, you can save
                valuable floor space for other things that bring you joy outside
                of cycling. But, if a Steadyrack gets you out cycling faster,
                well that’s just another good thing too!
              </p>
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-white text-4xl font-semibold tracking-tight mb-5">
                Save Space with a Pivot Ability
              </h1>
              <p className="text-base text-white mb-5 leading-tight">
                Simple to install and even easier to use, our indoor bike rack
                is the ultimate space saving solution. It’s unique ability to
                pivot lets users push their bike to the side, saving precious
                space, especially for those living in apartments or smaller
                homes! Some of our customers even make their indoor bike rack
                storage a statement piece in their homes. Because, if we do say
                so ourselves, they look seriously good.
              </p>
              <button className="py-3.5 px-5 bg-white text-black text-sm font-semibold rounded-full shadow-md border-2 border-black hover:bg-red-600 hover:text-white hover:border-white transition inline-flex items-center justify-center min-w-[40px]">
                SHOP NOW
              </button>
        ...
        <div className="px-5 grid grid-cols-2">
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              ...
              <p className="text-base test-black mb-5 leading-tight">
                The beauty of our bike rack is its versatility; it’s extremely
                convenient for city-dwellers or anyone who lives in an apartment
                or smaller house. Store your bike in a corner in your living
                room, in a cupboard (as some of our customers have done!) or if
                you have a small shed, store it in there. With your bikes safely
                stored vertically in our indoor bike racks, you’ll have peace of
                mind knowing they are secure and protected. For larger homes
                with garages, Steadyrack’s bike storage is the perfect solution.
                Store multiple bikes in your garage and pivot them closer to the
                wall, giving you enough space to park your car and store other
                belongings safely around your bikes. With Steadyrack, it’s
                possible to park your car AND keep your bikes organized in your
                garage. Think of all the extra things you can do with that
                space! We chose to buy more bikes…
              </p>
              <button className="py-3.5 px-5 bg-white text-black text-sm font-semibold rounded-full shadow-md border-2 border-black hover:bg-red-600 hover:text-white hover:border-white transition inline-flex items-center justify-center min-w-[40px]">
                SHOP NOW
              </button>
