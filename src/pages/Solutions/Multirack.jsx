    ...
    <div>
      <div data-aos="fade-up" className="relative h-screen overflow-hidden">
        ...
        <div className="relative flex justify-center items-end h-full text-center">
          <div className="">
            <h1
              data-aos="fade-up"
              className="text-9xl text-white font-bold font-impact uppercase italic tracking-tight mb-10"
            >
      ...
      <div data-aos="fade-up" className="py-20">
        <div className=" mx-96 px-5">
          <h1
            data-aos="fade-up"
            className="text-black text-4xl font-semibold text-center mb-7"
          >
            Steadyrack’s modular design makes it easy to install multiple racks,
            creating an efficient and organized storage solution for any space.
          </h1>
          <p
            data-aos="fade-up"
            className="text-black text-base tracking-tight text-center mb-4"
          >
            Steadyrack’s multiple bike rack storage has revolutionized the bike
            parking and bike storage industries by allowing cyclists from around
            the world to safely and effortlessly secure their bikes on virtually
            any wall and in almost any space. Steadyrack’s full range of
            products are the ideal solution for storing more bikes in less
            space. The unique and patented pivot action gives the option of
            leaving bikes in the central position or swivelling the rack to the
            left or right as the need arises. Each of the Steadyracks are safe
            to use, easy to install and utilize a roll in, roll out method.
            Whether you’re looking for multiple racks for your shed or garage,
            multiple bike rack storage for commercial bike parking (cafes,
            End-of-Trip, museums, schools, office buildings), at Steadyrack
            we’ve got the perfect bike rack storage for you and your project.
          </p>
        </div>
      </div>
      ...
      <div>
        <div data-aos="fade-up" className=" py-24">
          <h1 className="text-black text-4xl font-semibold text-center tracking-tight mx-44 px-5">
            Steadyrack’s patented pivot action lets you store multiple bikes
            upright and off the floor, while efficiently saving valuable space
            by angling racks neatly to fit your setup.
          </h1>
        </div>
      </div>
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              ...
              <p className="text-base test-black mb-5 leading-tight">
                Whether you have a large family, are a pro cyclist or simply
                enjoy riding, having multiple bikes in your collection makes
                bike storage complicated. Steadyrack is the solution to your
                bike rack storage issues. Whether it’s bike racks for 4, 5 or 6
                bikes, our award-winning, revolutionary design allows you to
                install multiple bike racks mounted on the wall next to each
                other, freeing up precious space in your garage, home, or
                apartment. The Steadyrack’s unique pivot action gives the option
                of leaving bikes in the central position or swivelling the rack
                to the left or right, as you need to, allowing bikes to fold
                over each other. Our multi bike racks provide an ideal storage
                solution where space is valuable, as they allow you to create
                more floor space.
              </p>
              ...
              <div className="flex flex-col">
                ...
                <div className="text-column">
                  ...
                  <p className=" leading-relaxed">
                    For limited wall space, this setup will allow you to store
                    more bikes in a smaller area. You can stagger the racks to
                    overlap your bikes, making this option perfect for
                    apartments and small sheds. Steadyracks can be placed as
                    close as 350mm (1ft 2in) apart.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="px-5">
              <div className="flex flex-col">
                ...
                <div className="text-column">
                  ...
                  <p className="leading-relaxed">
                    Optimise your floor space by pivoting your bikes as close to
                    the wall as possible. With more wall space, you can spread
                    the racks out to store your bikes closer to the wall, and
                    take up less floor space. This option is great for larger
                    spaces, like garages, and gives more freedom to move cars
                    and other equipment without moving your bikes. To achieve no
                    bike overlap, the racks may need to be 1200mm (~4ft) apart,
                    or more. When mounting racks at the same height, we
                    recommend a minimum of 600mm (2ft) between racks to allow
                    for the optimum pivot range.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="px-5 relative w-full h-screen flex items-center justify-center text-white">
          ...
          <div className="absolute bottom-5 left-5 w-[20%]">
            ...
            <p className="text-white font-semibold leading-tight">
              Steadyrack bike racks come with a comprehensive five-year
              warranty, providing you with peace of mind knowing that your
