      ...
      <div className="py-20">
        <div data-aos="fade-up" className=" mx-96 px-5">
          <h1 className="text-black text-4xl font-semibold text-center mb-7">
            Smart Solutions for Storing Bikes in Small Spaces
          </h1>
          <p className="text-black text-base tracking-tight text-center mb-4">
            When space is short, creativity is needed to find the best spot to
            store your bikes! There are a few ways you can store bikes in small
            spaces. Our customers have been creative over the years with storing
            them in cupboards, creating bike storage cabinets specifically
            around their bikes, and finding nooks and crannies around their home
            where they can install a Steadyrack. Bike storage for small spaces
            is easy with quality storage that’s designed specifically to save
            space.
          </p>
        </div>
      </div>
          ...
          <div className="flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-black text-4xl font-semibold tracking-tight mb-5">
                Have You Ever Seen A Bike Shed?
              </h1>
              <p className="text-base text-black mb-5 leading-tight">
                If you don’t have a dedicated bike storage space, creating a
                bike shed can be a practical and efficient solution. A
                well-organized bike shed helps free up space inside your home
                while keeping your bikes protected. Steadyrack Ambassador, Tom
                Cardy, uses Steadyrack bike racks in his bike shed set up. This
                has allowed him to store more of his bike collection securely
                without overcrowding his workshop. Check out Tom's bike shed
                creation here.
              </p>
              <p className="text-base text-black mb-5 leading-tight">
                Steadyrack bike racks are the ideal storage fix, so long as your
                balcony is closed in, or protected from the elements. To learn
                more about our warranty guidelines, head to our Standard
                Warranty page here!
              </p>
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-white text-4xl font-semibold tracking-tight mb-5">
                Installation Hacks for Small Spaces
              </h1>
              <p className="text-base text-white mb-5 leading-tight">
                Finding creative storage solutions is essential for apartment
                living and small spaces. Luckily, Steadyrack is the ultimate
                bike storage solution! You can install you Steadyrack behind
                doors or into cupboards to utilize your space. With the ability
                to pivot left and right, Steadyrack allows you to position bikes
                neatly out of the way, maximizing every inch of available room.
                Once you've identified the perfect spot, it's time to install!
                For detailed installation tips in small spaces,, head to our
