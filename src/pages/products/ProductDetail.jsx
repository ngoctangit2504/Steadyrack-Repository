...
const ProductDetailPage = () => {
  ...
  return (
    <div>
      <div className="max-w-screen-2xl mx-auto px-2 py-8 grid md:grid-cols-3 gap-12">
        ...
        <div className="flex flex-col col-span-1">
          <div className="grid grid-cols-2 mb-4">
            ...
            <a className="text-red-600 text-end hover:underline cursor-pointer">
          ...
          <div className="border-t mt-6">
            {["Why Steadyrack?", "What's Included?", "Shipping & Returns"].map(
              (title) => (
                <div
                  key={title}
                  className="border-b py-3 cursor-pointer flex justify-between items-center"
                >
      ...
      <RichTextTitle
        title={
          "Introducing ProFlex. Innovation meets modern design in the all-new ProFlex. Built for convenience and durability, it’s bike storage reimagined."
        }
      />
        ...
        <div className="px-5 mb-4">
          ...
          <div className="mx-10 px-5">
            <div className="grid grid-cols-12 gap-4">
              {" "}
              {/* Loại bỏ h-screen, để nội dung tự điều chỉnh */}
              <div className="col-span-3 p-4 text-white flex flex-col">
                {" "}
                {/* Loại bỏ items-center và justify-center từ đây */}
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  ...
                  >
                    A 3-hook system creates a secure support to either side of
                    the SteadySpine, Available in three sizes.
                  </p>
                </div>
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  <div className="flex items-center mb-3.5 border-black border-b">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    Functional design to maximize access to your gear. Available
                    in three sizes.
                  </p>
                </div>
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    An innovative robust glass-filled nylon spine designed to
                    support your gear.
                  </p>
                </div>
              </div>
              <div class="col-span-6 p-4 text-white flex items-center justify-center">
                {" "}
                {/* Thêm items-center và justify-center vào đây */}
                <img
              ...
              <div class="col-span-3 p-4 text-white flex flex-col">
                {" "}
                {/* Loại bỏ items-center và justify-center từ đây */}
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  <div className="flex items-center mb-3.5 border-black border-b">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    These versatile hooks can be flipped 180° to maximize use.
                  </p>
                </div>
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  <div className="flex items-center mb-3.5 border-black border-b">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    Obtuse exit angle allows for easy access and removal of
                    smaller items.
                  </p>
                </div>
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    A hook and loop fastener for easy attachment of your gear.
                  </p>
                </div>
                <div className="flex-shrink-0 w-full max-w-[320px] mb-14">
                  <div className="flex items-center mb-3.5 border-black border-b">
                  ...
                  <p
                    ...
                    className="text-black leading-tight text-sm font-semibold"
                  >
                    Allows for lockable positioning on all bins.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div
        data-aos="fade-up"
        className="relative w-full h-screen flex flex-col justify-start items-center text-center px-6 mx-6"
      >
        <div
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              ...
              <p className="text-base test-black mb-5 leading-tight">
                With over 200 arrangements, the GearMate storage organizer
                system lets you store your bike gear, your way.
              </p>
      ...
      <div className="my-6">
        <div className="w-full h-full object-cover">
          <VideoOverlay videoSrc={VideoBody} title="Steadyrack Ready" />
        </div>
      </div>
