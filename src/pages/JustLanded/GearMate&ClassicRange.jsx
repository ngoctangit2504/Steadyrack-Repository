...
function GearMateClassicRange() {
  ...
  return (
    <div>
      <div
        data-aos="fade-up"
        className="w-full h-screen bg-[url('https://eu.steadyrack.com/cdn/shop/files/Classic_GearMate_1.png?v=1742889266&width=3840')] bg-cover bg-center"
      >
        <div
          data-aos="fade-up"
      ...
      <div className=" pt-24 pb-10">
        <div className="px-5  grid grid-flow-row-dense grid-cols-3">
          ...
          <div className="col-span-2 mt-3.5 mb-5 pl-32 pr-2.5">
            ...
            >
              Following the launch of our newest innovations, ProFlex and
              GearMate, the question has been: Can I use GearMate with my
              existing Classic Range Steadyracks? The answer is YES. Our Classic
              Range includes the Classic, MTB, eBike, Fender, and Fat Rack. The
              GearMate is an adaptable storage organizer system that is
              compatible with both the Classic Range and the ProFlex Range.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 mx-3">
        <div className="px-2 relative overflow-hidden group">
          ...
          <p className="text-sm font-semibold tracking-tight">
            The GearMate SteadySpine is made from teflon coated aluminium and is
            the base of the GearMate system. Designed to seamlessly integrate
            behind the Classic Range racks and store your gear with ease.
          </p>
        </div>
        ...
        <div className="px-2 relative overflow-hidden group">
          ...
          <p className="text-sm font-semibold tracking-tight">
            The GearMate brackets come in three lengths: small, medium, and
            large, and are designed to slide & drop into the notches of the
            SteadySpine. This enables users to slide on their bins, hooks, and
            loop fasteners.
          </p>
        </div>
        ...
        <div className="px-2 relative overflow-hidden group">
          ...
          <p className="text-sm font-semibold tracking-tight">
            The SteadySpine and brackets allow over 200 arrangements, meaning
            you can store your gear, your way. Move the brackets around to
            utilize your space and store your helmet, shows, tools, and more.
          </p>
        </div>
      </div>
      ...
      <div className="pt-20">
        <div className="px-5 grid grid-cols-2">
          <div className="bg-black p-5">
            <h1 className="text-7xl text-white font-impact italic tracking-tight uppercase">
              GearMate Installation With Classic Range
            </h1>
          </div>
          <div>
            <video
        ...
        <div className="px-5 grid grid-cols-2 border-b border-gray-600 pb-2 ">
          <div className="">
            <h1 className="text-2xl tracking-tight font-semibold">
              Installing Your GearMate & Classic Range Rack
            </h1>
            <p className=" tracking-tight font-semibold">
              Your GearMate is installed by attaching all components to the
              SteadySpine. The SteadySpine is an additional purchase required
              when installing behind a Classic Range rack. Download the
              installation manual or watch the tutorial on how to install your
              new Gearmate with an existing Classic Range rack.
            </p>
            <h1 className="text-2xl tracking-tight font-semibold mt-5">Tips</h1>
            <p className=" tracking-tight font-semibold">
              Mark the two vertical mounting holes on the top and bottom
              mounting plate to determine where to line up your SteadySpine
              before removing your rack from the wall.
            </p>

            <button className="bg-white text-black py-3.5 px-5 mt-4 border-2 border-black rounded-full font-semibold hover:bg-red-700 hover:text-white transition block">
              GEARMATE + CLASSIC RANGE VIDEO
            </button>
            <button className="bg-white text-black py-3.5 px-5 mt-2 border-2 border-black rounded-full font-semibold hover:bg-red-700 hover:text-white transition block">
              DOWNLOAD MANUAL
            </button>
          </div>
        </div>
