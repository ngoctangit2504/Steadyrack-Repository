...
function CommercialBikeParking() {
  ...
  const faqs = [
    ...
    {
      question:
        "What's the difference between a Fender Rack and a Classic Rack?",
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
    },
  ];
      ...
      <div className="py-20">
        <div data-aos="fade-up" className=" mx-96 px-5">
          ...
          <p className="text-black text-base tracking-tight text-center mb-4">
            Our Steadyrack commercial wall mounted bike racks make efficient use
            of your space allowing people to easily load and unload their bikes.
            Featuring an award-winning design, our racks pivot, fold towards the
            wall and protect bikes from damaging other bikes, cars, and items in
            the vicinity. As the original innovators and leaders in bike parking
            solutions, no other commercial rack on the market matches our unique
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-black text-4xl font-semibold tracking-tight mb-5">
                Our Commercial Bike Racks Save Significant Space and Are Easy to
                Use
              </h1>
              <p className="text-base test-black mb-5 leading-tight">
                When designing End-of-Trip (EoT) parking for bikes, the most
                space efficient option is a frame mounted system or vertical
                wall mounted bike racks which is suitable for a commercial
                space.
              </p>
              <p className="text-base test-black mb-5 leading-tight">
                In a commercial or industrial space, our Steadyrack bike racks
                are ideal as they use a pushing and pulling action, as opposed
                to lifting vertically. When combined with the patented pivot
                design, this enables designers to park more bikes in much less
                space.
              </p>
              <p className="text-base test-black mb-5 leading-tight">
                Architects, designers, and planners from all over the world are
                acknowledging the benefits and features of Steadyrack as a
                commercial bike rack system. They know building owners and
                managers, along with their tenants are seeking commercial bike
                rack solutions that provide space efficient and user-friendly
                bike parking. Steadyrack provides more bike parking per square
                metre of space than any other system and the bike riding
                community is happy because they’re easy to use and it protects
                their bikes.
              </p>
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-white text-4xl font-semibold tracking-tight mb-5">
                Commercial Bike Parking Standards and Regulations
              </h1>
              <p className="text-base text-white mb-5 leading-tight">
                Our suggested spacing guides and mounting heights within our
                contain Design Guidelines information and recommendations that
                help to optimize the available space for your installation.
                Every country and city has specific commercial bike rack
                requirements that may differ from the recommendations.
              </p>
              <p className="text-base text-white mb-5 leading-tight">
                We recommend you check the standards or regulations for
                commercial bike parking in your country and location to ensure
                your designs comply.
              </p>
        ...
        <div className="px-5 grid grid-cols-2">
          ...
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              ...
              <p className="text-base test-black mb-5 leading-tight">
                Offering a safe, secure, accessible, and easy-to-use
                architecturalbike parking solution to cyclists will ensure a
                bike friendly destination for those in the office or community
                who use their bikes as a preferred method of transport.
              </p>
              <p className="text-base test-black mb-5 leading-tight">
                There are Steadyrack bike parking facilities around the globe in
                commercial spaces as varied as; offices, museums, End-of-Trip
                (EoT) facilities, cafes, apartment buildings, Government
                buildings, hospitals, Airbnb's, superyachts, and globally
                recognised businesses that choose Steadyrack as their preferred
                bike parking solution.
              </p>
              <p className="text-base test-black mb-5 leading-tight">
                Check out our Steadyrack Gallery , featuring commercial and
                personal installations from all over the world.
              </p>
      ...
      <div className="pt-9 pb-5 bg-black sticky top-0 z-[-2]">
        <div className="px-5 grid grid-cols-2">
          <div className=" flex px-1.5 items-center justify-center">
            <div data-aos="fade-up" className="py-10 px-20">
              <h1 className="text-white text-4xl font-semibold tracking-tight mb-5">
                Outdoor Bike Parking for Commercial Spaces
              </h1>
              <p className="text-base text-white mb-5 leading-tight">
                Renown for being one of the leading commercial bike rack
                manufacturers globally, our Steadyrack bike racks are
                manufactured from high grade materials that are robust, vandal
                resistant and secure. Our racks can be used for outdoor use if
                not directly exposed directly to the elements.
              </p>
              <p className="text-base text-white mb-5 leading-tight">
                If Steadyrack bike racks are installed where they are exposed to
                the elements, we recommend following a set of maintenance checks
                to ensure the rack continues to operate effectively. You can
                view the care and maintenance instructions
              </p>
              <p className="text-base text-white mb-5 leading-tight">
                Disclaimer: The warranty of the racks will be voided if they are
                installed where they are directly exposed to the elements.
              </p>
              <p className="text-base text-white mb-5 leading-tight">
                Interested in learning more about our outdoor bike parking
                options? Contact our sales department to find out.
              </p>
