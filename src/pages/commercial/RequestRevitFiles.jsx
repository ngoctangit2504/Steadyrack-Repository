    ...
    <div>
      <div className="py-20 pb-18">
        <div className="flex flex-col mx-80 px-5 justify-center items-center">
          ...
          <p className="font-semibold tracking-tight mb-4 text-center">
            Fill out the form below to gain access to download our Revit files,
            Bike Parking Brochure along with our Spacing and Mounting Guide.
          </p>
        </div>
      </div>
