...
function IndoorBikeParking() {
  ...
  const faqs = [
    ...
    {
      question: "Do the racks swing freely/why doesn't my Steadyrack swivel easily?",
      answer:
...
<div className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex justify-center items-end h-full text-center">
        <div className="">
          <h1 className="text-9xl text-white font-bold font-impact uppercase italic tracking-tight mb-10">INDOOR BIKE PARKING</h1>
        </div>
      </div>
    </div>
    ...
    <div className='py-20'>
        ...
        <div className='px-5 grid grid-cols-2'>
           ...
           <div className=' flex px-1.5 items-center justify-center'>
             <div data-aos="fade-up" className='py-10 px-20'>
                <h1 className='text-black text-4xl font-semibold tracking-tight mb-5'>Commercial Indoor Bike Parking for Office Buildings</h1>
                <p className='text-base test-black mb-5 leading-tight'>Installing EOT indoor bike parking facilities at your office is an excellent way to encourage more employees to take up cycling and ensure those who already commute on their bikes have a safe place to store them during the day. With Steadyrack’s indoor bike parking, you can ensure employee’s bikes are safe from theft and the elements outside. Help your employees store it easily with Steadyrack so they start the day on the right foot.</p>
     ...
     <div className='pt-9 pb-5 bg-black'>
        ...
        <div className=' flex px-1.5 items-center justify-center'>
             <div data-aos="fade-up" className='py-10 px-20'>
                <h1 className='text-white text-4xl font-semibold tracking-tight mb-5'>Commercial Indoor Bike Parking for Bike Stores</h1>
                <p className='text-base text-white mb-5 leading-tight'>What do you need when you’re selling bikes? Excellent bike storage, of course! Keep your stock safe and protected with our commercial indoor bike racks. Used by the likes of Trek, Giant, Scott Sports and Specialized to store their bikes in-store, you’re in trusted hands with Steadyrack’s indoor bike parking solutions. Our Revit files and design guidelines are easily found on our website, or simply reach out to discuss your commercial indoor bike parking needs today.</p>
                <button className="py-3.5 px-5 bg-white text-black text-sm font-semibold rounded-full shadow-md border-2 border-black hover:bg-red-600 hover:text-white hover:border-white transition inline-flex items-center justify-center min-w-[40px]">
                GET A QUOTE
                </button>
             </div>
...
<div className='py-20'>
        ...
        <p className='text-black text-base tracking-tight text-center mb-4'><span className=' font-bold'>Please note:</span> We can customize colours to suit your building fit out. Minimum order quantities apply. Contact us to enquire.</p>
           ...
           <a className='block text-black text-base tracking-tight text-center mb-4 font-bold underline'>Revit Files</a>
           <a className='block text-black text-base tracking-tight text-center font-bold underline'>Design Guidelines</a>
           <a className='block text-black text-base tracking-tight text-center mb-4 font-bold underline'>& Product Data Sheets</a>

           <a className='block text-black text-base tracking-tight text-center font-bold underline'>Commercial Care &</a>
           <a className='block text-black text-base tracking-tight text-center mb-4 font-bold underline'>Maintenance Instructions</a>
