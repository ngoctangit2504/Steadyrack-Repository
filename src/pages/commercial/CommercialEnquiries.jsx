      ...
      <div className="py-20 pb-18">
        <div className="flex flex-col mx-80 px-5 justify-center items-center">
          ...
          <p className=" font-semibold tracking-tight mb-4">
            Whether you're looking for a quote for your commercial project,
            spacing and layout guidance, or wish to discuss an upcoming project,
            we are here to help. Please fill out this form and our Sales team
            will be in touch.
          </p>

          <div className="flex flex-row">
            <span className=" font-bold">Phone:</span>
            <p className=" font-semibold tracking-tight underline">
              {" "}
              +61 8 9435 2435
            </p>
          </div>
          ...
          <div className="flex flex-row">
            ...
            <p className="tracking-tight mb-4 underline">
              {" "}
              Facebook.com/steadyrack
            </p>
          </div>

          <p className="tracking-tight font-bold">Visit us:</p>
          <p className="tracking-tight mb-4">
            46 Discovery Drive, Bibra Lake, WA, 6163
          </p>
          <p className=" font-bold tracking-tight">Opening hours:</p>
          <p className="tracking-tight mb-4">
            Monday to Friday, 9am - 5pm AWST (Australian Western Standard Time)
          </p>
          <p className=" tracking-tight text-center">
            Our Customer Support team are based in Western Australia and will
            respond to your inquiry as soon as possible during open hours.
          </p>
        </div>
      </div>
