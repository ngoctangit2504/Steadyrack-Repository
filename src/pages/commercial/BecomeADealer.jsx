  ...
  return (
    ...
    <div className='py-20 pb-18'>
     <div className='flex flex-col mx-80 px-5'>
       <h1 className=' text-5xl font-semibold tracking-tight mb-12'>Become A Dealer</h1>
       <p className=' font-semibold tracking-tight mb-4'>We work with dealers all over the world. From Canada to Colombia, the United States to the United Kingdom, Switzerland to New Zealand and everywhere in between.</p>
       <p className=' font-semibold tracking-tight mb-4'>Our authorized dealers promote and sell Steadyrack online and in store, along with featuring in their window displays, storage areas, workshops and showrooms.</p>
       <p className=' font-bold tracking-tight mb-4 underline'>For United States Dealer Support contact:</p>
       ...
       <p className=' font-semibold tracking-tight mb-4'>If you’re interested in working with the best bike parking solution available, fill out the short form below and we’ll be in touch soon after that.</p>
      </div>
    </div>
