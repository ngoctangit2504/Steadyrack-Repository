...
function NeedHelp() {
  ...
  <ArrowDownIcon className="w-5 h-5" />
              ...
              <div className="grid grid-cols-3">
                ...
                <div className="col-span-2">
                  <p className="text-xl tracking-tight">
                    Some bikes, such as time trial bikes, have a narrow spacing
                    between the downtube and the tire...
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="step3" className="mb-16 min-h-[33vh]">
              ...
              <div className="grid grid-cols-3">
                ...
                <div className="col-span-2">
                  ...
                  <p className="text-xl tracking-tight">
                    The tire width will determine which size rack to purchase...
                  </p>
                </div>
              </div>
            </div>
          </div> {/* End cột nội dung */}
        </div>
      </div>
    </div>
     ...
     <div className='pt-12'>
      <div className='px-5 mb-7'>
        <h1 className=' font-impact tracking-tight text-7xl italic uppercase'>ProFlex Range</h1>
      </div>
     </div>
          ...
          <div id="step4" className="min-h-[50vh]">
            ...
            <div className="grid grid-cols-3">
              ...
              <div className="col-span-2">
                ...
                <p className="text-xl tracking-tight">
                  The ProFlex works by sliding between the fender/mudguard and tire when rolling the bike onto the rack.
                </p>
              </div>
            </div>
          </div>
