      ...
      <div className='grid grid-cols-3'>
        <div className="col-span-1">
         ...
         <div className="col-span-2">
           <h1 className=" text-6xl tracking-tight font-semibold mb-5">Not sure which ProFlex to choose for your bike?</h1>
           <p className=" text-xl tracking-tight">Follow the steps below to work out which size of our ProFlex Racks is the right fit for your bike.</p>
         </div>
