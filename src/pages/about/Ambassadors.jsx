...
function Ambassadors() {
  return (
    <div>
      <div>
        <BackRoundIntro imageSrc={imageTop} text="STEADYRACK AMBASSADORS" />
      </div>
          ...
          <div className="px-5 grid grid-cols-2 grid-rows-3">
            <div className="p-2.5 bg-black">
              <div className="p-2.5 bg-white flex flex-col justify-center items-center h-full">
                <p className="font-semibold text-2xl w-[50%]">
                  Bringing together top-tier talent from MTB, gravity, BMX and
                  ultra-cycling disciplines, our athlete ambassadors are leaders
                  in their field who push limits and ride hard. They’ll show you
                  how they give it their all on the track and rely on Steadyrack
                  for effortless bike storage.
                </p>
              </div>
            </div>
            ...
            <div className="relative p-2.5 overflow-hidden">
              ...
              <div className="absolute left-10 bottom-10 space-y-2">
                <h1 className="text-white text-4xl tracking-tight font-semibold">
                  Jack Thompson
                </h1>
                <p className="text-white text-2xl tracking-tight font-semibold">
                  Australia Ultra-Cycling
                </p>
                <ButtonD />
              </div>
            </div>
            ...
            <div className="p-2.5 ">
              <div className="relative flex mx-auto text-center py-12 md:py-20 md:pb-24 h-full flex-col justify-center bg-white">
                ...
                >
                  ...
                  >
                    <p>
                      Get in touch with our team to discuss partnership
                      opportunities.
                    </p>
                  </div>
