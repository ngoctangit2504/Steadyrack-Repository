...
function AboutUs() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const videoTop =
        containerVideoRefs[0].current.getBoundingClientRect().top;
      ...
      const newStates = isExpandedVideo.map((state, index) => {
        if (!videoRefs[index].current || !containerVideoRefs[index].current)
          return state;
    ...
    <div>
      <div data-aos="fade-up" className="relative w-full h-screen mb-32">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-end pb-16 bg-black bg-opacity-40">
          <h1
            data-aos="fade-up"
            className="text-white text-[10rem] leading-none uppercase italic tracking-[-0.1em] skew-x-10 font-zuume whitespace-nowrap"
          >
            Original Innovators.
          </h1>
        </div>
        ...
        >
          <div className="pt-28 pb-10 px-5 text-center">
            <h1 className="font-impact tracking-tight text-6xl uppercase italic w-[80%] mx-auto">
              Steadyrack is for Space Savers and Adventure{" "}
            </h1>
            <h1 className="font-impact tracking-tight text-6xl uppercase italic w-[80%] mx-auto">
              Seekers. Our clever, innovative solutions
            </h1>
            <h1 className="font-impact tracking-tight text-6xl uppercase italic w-[80%] mx-auto">
              maximize space and make room for your next
            </h1>
            <h1 className="font-impact tracking-tight text-6xl uppercase italic w-[80%] mx-auto">
              great adventure.
            </h1>
        ...
        <div className="container mx-auto flex flex-col md:flex-row gap-8 relative">
          <div className="w-full md:w-[60%] flex flex-col items-start text-left text-white px-6">
            ...
            <div className="leading-none text-lg md:text-xl mt-11">
              <p className="w-1/2 leading-tight tracking-tight">
                Since 2009, Steadyrack has led the way in bike storage globally
                as the pivoting pioneers. Born in an Australian garage, our
                journey started with a cyclist's simple need for smarter
                storage.
              </p>
              <p className="w-1/2 leading-tight mt-10 tracking-tight">
                Steadyrack is a family-owned and operated business that has
                grown into a global brand, proudly headquartered in our hometown
                of Perth, Western Australia.
              </p>
              <p className="w-1/2 leading-tight mt-10 tracking-tight">
                Now, for the first time in history, we're redefining bike
                storage once again. Welcome to the next era of Steadyrack.
              </p>
            </div>

            <div className="text-base mt-24">
              <p className="leading-tight tracking-tight">
                Fueled by innovation and passion, Steadyrack has set the global
                standard in bike storage. Our commitment to cutting-edge,
                reliable solutions makes us the top choice now and in the
                future.
              </p>
              <p className="leading-tight tracking-tight mt-5">
                Today, we've earned the trust of cyclists and organizers
                worldwide, including some of the most iconic brands and largest
                organizations including offices, museums, End-of-Trip (EoT)
                facilities, cafes, apartment buildings, government buildings,
                hospitals, Airbnb's, and superyachts.
              </p>
            </div>
          </div>
      ...
      <div>
        <VideoOverlay
          videoSrc="https://www.steadyrack.com/cdn/shop/videos/c/vp/4981503b09b64f0a9a711c2743874fd3/4981503b09b64f0a9a711c2743874fd3.HD-1080p-7.2Mbps-41063554.mp4?v=0"
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="relative w-full aspect-square overflow-hidden group">
              ...
              <div className="absolute bottom-4 left-4 text-white p-4 rounded-lg">
                ...
                <button className="bg-white text-black w-12 h-12 flex items-center justify-center rounded-full font-semibold group-hover:bg-red-700 group-hover:text-white transition">
                  <svg
            ...
            <div className="relative w-full aspect-square overflow-hidden group">
              ...
              <div className="absolute bottom-4 left-4 text-white p-4 rounded-lg">
                ...
                <button className="bg-white text-black w-12 h-12 flex items-center justify-center rounded-full font-semibold group-hover:bg-red-700 group-hover:text-white transition duration-300">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
      ...
      <div
        data-aos="fade-up"
        className="w-full h-screen bg-[url('https://eu.steadyrack.com/cdn/shop/files/Solutions_2.png?v=1739873754&width=600')] bg-cover bg-center"
      >
        <div
          data-aos="fade-up"
          className="py-5 px-5 w-full h-full bg-transparent flex flex-col justify-center items-center"
        >
          <div
            data-aos="fade-up"
            className="text-9xl font-bold mb-7 font-impact tracking-tight uppercase italic text-white text-center"
          >
            READY
            <span
              style={{
          ...
          <p
            data-aos="fade-up"
            className="text-4xl text-white font-semibold tracking-tight mb-7 text-center"
          >
